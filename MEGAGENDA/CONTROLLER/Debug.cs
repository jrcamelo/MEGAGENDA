    ...
    public static class Debug
    {
        ...
        public static void SpamAdd()
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                Evento e = new Evento(pid, i.ToString(), pid.ToString(), 1200, new List<string> { "Nido" }, "Primeira", new Endereco("teste"), DateTime.Today, DateTime.Today, DateTime.Today, 4, true, true, 0, "Vai ser muito legal", new List<Pagamento>() { new Pagamento(1, 0, DateTime.Today, true, 1) });
                Evento.Add(e);
            }
            timer.Stop();
