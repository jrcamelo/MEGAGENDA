...
namespace MEGAGENDA.MODEL
{
    ...
    public class Modelo
    {
        ...
        public void padrao_teste()
        {
            ...
            Clausulas_Contrato.Add("Serão impressas até 4 (quatro) cópias de cada montagem feita pela Cabine sem número máximo de impressões durante os [EVENTO DURACAO_MINUTOS].");
